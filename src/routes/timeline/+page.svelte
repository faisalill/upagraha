<div class="hero min-h-screen bg-base-200">
  <div class="hero-content text-center">
    <div class="max-w-md relative top-14">
  ...
  <li>
    ...
    <div class="timeline-start timeline-box md:text-end mb-10">
      ...
      <div class="text-lg font-black">First Plan Draft</div>
  ...
  <li>
    ...
    <div class="timeline-start timeline-box md:text-end mb-10">
      <time class="font-mono italic">2012</time>
  ...
  <li>
    ...
    <div class="timeline-start timeline-box md:text-end mb-10">
      <time class="font-mono italic">2026</time>
